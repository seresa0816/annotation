		...
		main.canvas.on("mouse:down", function(evt)
		{
			...
			switch(main.shape)
			{
				...
				case "text" :
					...
					$("#popup_text textarea").css("width", main.textWidth + "px");
					$("#popup_text textarea").css("height", main.textHeight + "px");
		...
		main.canvas.on("mouse:up", function(evt)
		{
			...
			switch(main.shape)
			{
				case "rect":
					...
					$("#popup_text textarea").css({"font-size" : main.fontSize});
					$("#popup_text textarea").css({"color" : main.fontColor});
					$("#popup_area").css("left", main.drawObj.left + "px");
					$("#popup_area").css("top", main.drawObj.top + "px");
					$("#popup_text textarea").focus();
					$("#popup_text textarea").css("width", main.drawObj.width + "px");
					$("#popup_text textarea").css("height", main.drawObj.height + "px");
					main.showPopup("popup_text");					
				break;
				case "text":
