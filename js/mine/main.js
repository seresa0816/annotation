...
var initEnv			= function()
{
				...
				case 0 :
					...
					//	alert(obj);
						...
						if(!obj._objects)
						{
							...
							$("#popup_area").css("left", left + main.drawObj.margin_l + "px");
							$("#popup_area").css("top", top + "px");
							$("#popup_text textarea").focus();
							$("#popup_text textarea").css("width", main.drawObj.textWidth + "px");
							$("#popup_text textarea").css("height", main.drawObj.textHeight + "px");
	...
	main.initFonts 		= function()
	{
		...
		{
			main.drawObj.fontSize = $(this).html() * 2;
